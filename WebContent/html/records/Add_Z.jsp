...
cache:true,
asynce:true,
url:"${pageContext.request.contextPath}/case.do",
...
$("#pi_id").append(content);
	...
	data:"pi_id="+$("#pi_id").val()+"&opt1=queryAll",
	 cache:true,
     asynce:true,
     url:"${pageContext.request.contextPath}/case.docase.do",
      dataType:"json",
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center"><input name="submit1" type="button"
				...
				value=" 返回 " onClick="window.location.href='${pageContext.request.contextPath}/case.do?opt=queryAll'">
			</td>
			<td>&nbsp;&nbsp;&nbsp;</td>
			<td>&nbsp;&nbsp;&nbsp;</td>
		</tr>
