  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">公告信息的删除/修改      
        </td>
      </tr>
    </table></td>
  </tr>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
    ...
    <td class="td_01">&nbsp;&nbsp;&nbsp;我发布过的公告</td>
  </tr>
 
 
  <tr>

    <td class="td_top">公告类型</td>
    <td class="td_top">公告内容</td>
    <td class="td_top">发布日期</td>
    <td class="td_top">操作</td>
  

  </tr>
  <tr>
    <td class="td07">提醒信息</td>
      <td class="td07">杨国春发布了一篇手稿</td>
    <td class="td07">2016-05-20</td>
 
    <td class="td07">
                            <a href="medicalInfoList.jsp" target="mainFrame">删除</a>
                            <a href="annouceModify.jsp" target="mainFrame">修改</a></td>
