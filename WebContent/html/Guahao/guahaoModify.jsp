...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<center>
		...
		<form name="form1" method="post" action="${pageContext.request.contextPath}/RegisteredServlet?method=modyfyInfo&site=0&reid=${registered.reid }">
			<table width="95%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="90" height="24" class="td_form01">就诊卡号</td>
					<td width="400" class="td_form02">
					<input name="piid" type="text" class="input" id="piid" value="${registered.patientinformation.piid }" >
				...
				<tr>
					...
					<td class="td_form02"><select name="type" id="type">
							<option value="${registered.typeoftreatment.tyid }">${registered.typeoftreatment.tyname }</option>
