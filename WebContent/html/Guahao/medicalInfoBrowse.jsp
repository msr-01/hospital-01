			...
			<td height="25" align="center" valign="bottom" class="td06"><table
					...
					<tr>
						<td width="15"><img
							...
							width="9" height="9"></td>
						<td valign="bottom" class="title">药品信息查询 <a
							href="message.jsp" style="list-style-type: none"
							class="buttonface11" id="buttonface2">返回</a>
						</td>
					</tr>
				</table></td>
		</tr>
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td class="td_page">药品编号： <input name="PARA_YM_NOW" size="20"
				type="text" class="input" id="PARA_YM_NOW" next="A001014"
				value="xy0012" onFocus="{obtainFocus(this),this.select()}"
				onKeyPress="gotoNextInput(this)" onBlur="matchInput(this)">
				药品名称：<input name="PARA_YM_NOW2" size="20" type="text" class="input"
				id="PARA_YM_NOW2" next="A001014" value=""
