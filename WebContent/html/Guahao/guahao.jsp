		...
		<center>
			...
			<form name="form1" method="post" action="">
				<table width="95%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="90" height="24" class="td_form01">门诊卡号</td>
				...
				<br>
					<table width="95%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td align="center">
							<input name=save type="button" class=buttonface value="提交"
								onclick="location.href='${pageContext.request.contextPath}/html/media/applicationlist_1.jsp'">
								
							<input name="Reset" type="button" class="buttonface" value="重置"
								onClick="location.href='${pageContext.request.contextPath}/html/html/guahao.jsp'">
