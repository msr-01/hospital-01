...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<br>
	<form action="${pageContext.request.contextPath}/OperationRecordServlet?method=searchOR&site=0" method="post">
		<table width="95%" border="0" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
				<td class="td_page">
					工号： <input name="jobnumber" size="10" type="text" class="input">
					用户名：<input name="uname" size="10" type="text" class="input">
	...
	<table width="95%" border="0" align="center" cellpadding="0"
		...
		<c:forEach var="orl" items="${oplist }">
			<tr align="center">
				<td class="td07">${orl.orid }</td>
				<td class="td07">${orl.operationType.otname }</td>
				<td class="td07">${orl.ortime }</td>
				<td class="td07">${orl.userInfos.uname }</td>
				<td class="td07">${orl.userInfos.characte.roleName.rname }</td>
			</tr>
		</c:forEach>
	</table>
