...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="25" align="center" valign="bottom" class="td06"><table
					...
					<tr>
						<td width="15">
							<img src="${pageContext.request.contextPath}/images/index_32.gif"
							width="9" height="9">
						</td>
	...
	<br>
	<form action="${pageContext.request.contextPath}/DrugSevlet?method=medicinefindAll" method="post">
	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
			<td class="td_page">
				...
				<a href="${pageContext.request.contextPath}/html/medicine/addMedicine.jsp" target="mainFrame">&nbsp;&nbsp;添加药品信息</a>
			</td>
		</tr>
	</table>
	</form>
		...
		<c:if test="${!empty drList}">
			<c:forEach var="drug" items="${drList}">
				<tr align="center">
					...
					<td class="td07">${drug.drformat}</td>
					...
					<td class="td07">
					<a href="${pageContext.request.contextPath}/DrugSevlet?method=ModifyDrug1&drid=${drug.drid}" target="mainFrame">修改</a>
					<a href="${pageContext.request.contextPath}/DrugSevlet?method=deleteDrug&drid=${drug.drid}" target="mainFrame">&nbsp;&nbsp;删除</a></td>
				</tr>
			</c:forEach>
		</c:if>
	</table>
